<?php
/*
Plugin Name: Wp-Pepipost (Vitaly Kukin fixed)
Version: 3.0.1
 ...
 */
function wp_pepipost_scripts_method( $hook ) {

    if( strpos( $hook, 'pepipost' ) === false )
        return;

    wp_deregister_script( 'jquery' );
    wp_register_script( 'jquery', "https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js", false, '3.3.1' );

    wp_register_style( 'bootstrap-3.3.7', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', false, '3.3.7' );
    wp_register_style( 'wp-pepipost', plugin_dir_url( __FILE__ ). 'css/wp-pepipost-ui.css', [ 'bootstrap-3.3.7' ], '1.11.4' );
    ...
    wp_register_script( 'bootstrap-3.3.7', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', ['jquery'], '3.3.7' );
    wp_enqueue_script( 'custom-script', plugin_dir_url( __FILE__ ) . 'js/jquery.canvasjs.min.js', ['jquery', 'bootstrap-3.3.7' ] );
    wp_enqueue_script( 'custom-js', plugin_dir_url( __FILE__ ) . 'js/tabs.js', ['jquery'] );

    wp_register_style( 'custom-style', plugin_dir_url( __FILE__ ) . 'css/wp-pepipost-style.css', false, '1.0.0' );
